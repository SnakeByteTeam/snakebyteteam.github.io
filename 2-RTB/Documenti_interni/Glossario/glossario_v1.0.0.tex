...
Una GitHub Action è un componente di automazione che consente di eseguire flussi di lavoro programmabili in risposta a eventi in un repository su GitHub, 
facilitando processi come integrazione continua, test e distribuzione del software.
...
\section{H}
\subsection*{Hunspell}
Hunspell è un motore open source per la correzione ortografica basato su dizionari e regole morfologiche. Consente di identificare errori lessicali 
e generare suggerimenti correttivi, ed è ampiamente impiegato in applicazioni come LibreOffice e vari browser web.
