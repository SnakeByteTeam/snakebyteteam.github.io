...
\setcounter{secnumdepth}{0}   % disattiva la numerazione
...
Interfaccia di programmazione che permette a software esterni di collegarsi e interagire con dispositivi domotivi conformi allo standard KNX, 
...
progetto software. Viene reddato dal proponente e presentato ai fornitori o agli sviluppatori interessati a partecipare alla gara 
...
Il committente è l'individio o l'organizzazione che commissiona la realizzazione di un progetto software e ne finanzia lo sviluppo. Esso è responsabile della definizione dei
...
sviluppo per la gestione di progetti, permette la tracciabilità delle modifiche al codice sorgente e la collaborazione fra i menmbri del team, facilitandone 
il coordinamento.
...
\subsection*{Mocking}
In ingegneria del software è una tecnica che permette di isolare e testare con facilità una porzione del programma sfruttanto degli oggetti (mock) che simulano 
