...
\begin{itemize}
    ...
    \item organizzazione del repository dei documenti.
...
\subsection*{Organizzazione del repository dei documenti}
...
È stato deciso che gli amministratori si occuperanno di riportare il \textit{repository} ad uno stato consono e facilmente utilizzabile.
...
\addTodo{ - }{Pulizia del repository e \textit{merge} dei \textit{branch} pendenti nel \texttt{develop}}{F. Venzo, G. De Fina}{04/02/2026}
