...
\newpage
\addChangelog{1.0.1}{26/01/2026}{V. Baleanu}{\noOne}{V. Baleanu, M. Sciacco}{Ri-approvazione del documento a seguito di aggiornamento dello stato del documento. Nessuna modifica al contenuto.}
\addChangelog{1.0.0}{16/01/2026}{\noOne}{\noOne}{V. Baleanu, M. Sciacco}{Approvazione interna ed esterna del documento}
\addChangelog{0.1.2}{26/12/2025}{C. Libralato}{F. Pasqual}{\noOne}{Correzione errori ruoli}
\addChangelog{0.1.1}{12/12/2025}{F. Pasqual}{L. Pellizzon}{\noOne}{Modifiche Q\&A dashboard}
\addChangelog{0.1.0}{27/12/2025}{G. de Fina}{V. Baleanu}{\noOne}{\firstDraft}
\makeChangelog
...
Per quanto riguarda \textbf{l'autenticazione e i permessi}:
\begin{itemize}
...
\end{itemize}
Per quanto riguarda \textbf{gli allarmi e le loro priorità} :
\begin{itemize}
...
\end{itemize}
Per quanto riguarda \textbf{la gestione degli impianti} :
\begin{itemize}
    ...
    \item l'amministratore dovrà, al primo accesso, selezionare quali impianti gestire tra quelli disponibili tramite il proprio account \textit{MyVimar}.
\end{itemize}
Per quanto riguarda \textbf{la dashboard e l'interfaccia} :
\begin{itemize}
    \item la dashboard deve permettere all'OSS di disattivare un allarme qualsiasi sia il caso che l'ha generato in prima istanza;
    \item è auspicabile che la dashboard permetta all'OSS di prendere in carico (come sua propria responsabilità [di utente registrato]) un allarme e di disattivarlo non appena ha gestito il caso critico (azione \textit{nice to have});
...
La parte di suggerimenti e \textit{analytics} dovrà essere gestita tramite logiche statiche, soglie predefinite ed eventuali algoritmi di \textit{AI} semplici.
...
\addTodo{\noOne}{Decisione definitiva sul sistema di tracciamento delle attività di progetto}{\teamName}{01/12/2025}
