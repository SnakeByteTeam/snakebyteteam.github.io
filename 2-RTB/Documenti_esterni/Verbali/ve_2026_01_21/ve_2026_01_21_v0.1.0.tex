...
\newpage 
\addChangelog{\docVersion}{22/01/2026}{V. Baleanu}{L. Granziero}{\noOne}{Prima stesura}
\makeChangelog
...
\end{itemize}
Per quanto riguarda invece i grafici delle \textit{analytics}, la proponente ha affermato che è 
...
\begin{itemize}
  ...
  \item Disegno architetturale del progetto presentato tramite il modello C4, il quale scompone il sistema \textit{software} in livelli gerarchici (\textit{System, Container, Component} e \textit{Code}), permettendo una rappresentazione progressiva e strutturata;
...
\addTodo{\noOne}{Valutare la stategia migliore per esporre l'\textit{endpoint} pubblico}{\teamName}{27/01/2026}
\addTodo{\noOne}{Valutare la strategia migliore per il recupro dell'identificatore dei dispositivi \textit{IoT} a partire dall'identificatore del \textit{datapoint}}{\teamName}{27/01/2026}
