...
\begin{itemize}
  ...
  \item Disegno architetturale del progetto presentato tramite il modello C4, il quale scompone il sistema \textit{software} in livelli gerarchici (\textit{System, Container}$_G$\textit{, Component} e \textit{Code}), permettendo una rappresentazione progressiva e strutturata;
