...
\begin{itemize}
    \item \textbf{Analisi dei Requisiti}: aggiornamento alla versione 1.1.0 con aggiunta e modifica di alcuni \textit{use case};
...
\begin{itemize}
    \item \rif{RO7} e \rif{RO8} - Sovrastima e sottostima costi e ore: è stata riscontrata una sottostima nell'assegnazione delle ore per alcuni ruoli (Christian: +1 ora, Giuseppe: +4 ore, Valeria: +8 ore, Leonardo: +4 ore, Filippo: +1 ora) 
    e una sovrastima per altri (Francesco: -1 ora e -15 ore per il ruolo di Progettista che in questo sprint nessuno ha svolto).
