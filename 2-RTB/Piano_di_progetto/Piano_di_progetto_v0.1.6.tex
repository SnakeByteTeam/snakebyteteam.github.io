...
\begin{itemize}
    \item \rif{RO8} e \rif{RO7} - Sottostima e sovrastima costi e ore: è stata riscontrata una sottostima nell'assegnazione delle ore per alcuni ruoli (Christian: +1 ora, Giuseppe: +4 ore, Valeria: +8 ore, Leonardo: +4 ore, Filippo: +1 ora) 
...
hanno evidenziato un carico di lavoro superiore alle stime iniziali. Per far fronte 
