...
Nel corso del periodo di avanzamento sono state svolte le seguenti attività:
\begin{itemize}
    \item L'Analisi dei Requisiti non è stata completata ma ha subito de
\end{itemize}
...
\begin{itemize}
    \item \rif{RI2} - Impegni universitari: il gruppo ha riscontrato difficoltà nel bilanciare gli impegni accademici, derivanti dalla sessione di esemi, con le attività di progetto.
    ...
    \item \rif{RO1} - Carico di lavoro eccessivo: alcuni membri del gruppo hanno trovato il carico di lavoro eccessivo, soprattutto in relazione al rischio \rif{RI2}, ovvero gli impegni universitari paralleli.
            \\La mitigazione è avvenuta attraverso una ridistruzione del lavoro tra i membri e una revisione della priorità delle attività, individuando quelle maggiormente posticipabili.
