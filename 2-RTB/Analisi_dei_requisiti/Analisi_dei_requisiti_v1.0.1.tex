...
\addInclusione{Visualizzazione Modulo opzionale Dashboard \rif{2.1}}
\addInclusione{Visualizzazione Modulo gestione allarmi \rif{2.2}}
...
\addScenarioPrincipale{L'utente visualizza, nella Dashboard, i Moduli da lui selezionati. (Vedi \rif{2.3})}
\addTrigger{L'utente vuole visualizzare un Modulo opzionale nella Dashboard.}
\makeUC{2.1}{Visualizzazione Modulo opzionale Dashboard}
...
\makeUC{2.2}{Visualizzazione Modulo gestione allarmi}
...
\addInclusione{Selezione Modulo non presente \rif{2.4.1}}
\addEstensione{Selezione Modulo già presente \rif{2.3.1}}
\addEstensione{Limite Moduli raggiunti \rif{2.3.2}}
\addTrigger{L'utente vuole modificare quali Moduli sono visualizzati nella Dashboard}
\makeUC{2.3}{Aggiunta Modulo opzionale Dashboard}
...
\makeUC{2.3.1}{Selezione Modulo già presente nella Dashboard}
...
\makeUC{2.3.2}{Errore limite Moduli visualizzabili nella Dashboard}
...
\addInclusione{Selezione Modulo già presente \rif{2.3.1}}
\addEstensione{Selezione Modulo non presente \rif{2.4.1}}
\addTrigger{L'utente vuole rimuovere un Modulo opzionale dalla Dashboard}
\makeUC{2.4}{Rimozione Modulo opzionale Dashboard}
...
\makeUC{2.4.1}{Selezione modulo non presente in Dashboard}
