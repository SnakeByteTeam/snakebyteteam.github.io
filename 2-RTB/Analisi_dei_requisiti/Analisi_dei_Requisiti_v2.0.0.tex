...
\newcommand\Erpte{41} % Errore username non registrato o password temporanea errata
\newcommand\Ernpupt{42} % Errore nuova password è uguale alla password temporanea
...
\section{Requisiti}{
  ...
  \addReqF{1}{L'\admin deve poter rimuovere dalla visualizzazione della dashboard il modulo analisi consumi}{\rif{18}}
  ...
  \addReqV{2}{Consegnare una documentazione sull’architettura realizzata tramite il modello C4 (diagramma di contesto e di
      container) e/o altri tipi di schemi}{\capitolato\S6.1}
  \addReqV{2}{Consegnare bozzetti grafici relativi alla progettazione di design dell’applicativo web responsive}{\capitolato\S6.1}
  \addReqV{2}{Consegnare documentazione sintetica della libreria backend (se implementata)}{\capitolato\S6.1}
  \addReqV{2}{Consegnare spese stimate della propria soluzione in Cloud AWS in base ai servizi previsti}{\capitolato\S6.1}
  \addReqV{2}{Consegnare la documentazione dei casi d'uso per l’utilizzo dell’applicativo web.}{\capitolato\S6.1}
  \addReqV{0}{Consegnare la documentazione delle API backend}{\capitolato\S6.1}
  \addReqV{0}{Consegnare la documentazione di tutti i test realizzati e report, con relativo coverage e risultato.}{\capitolato\S6.1}
  \addReqV{0}{Consegnare codice sorgente (accessibile al pubblico dominio) con licenza open source e con un file README
      contenente le istruzioni di installazione e primo utilizzo.}{\capitolato\S6.1}
  \addReqV{0}{Consegnare screenshot e video dimostrativo della soluzione in funzione.}{\capitolato\S6.1}
  \addReqV{0}{Consegnare manuale di utilizzo dell’applicativo web per gli utenti.}{\capitolato\S6.1}
  \makeReqVtable
