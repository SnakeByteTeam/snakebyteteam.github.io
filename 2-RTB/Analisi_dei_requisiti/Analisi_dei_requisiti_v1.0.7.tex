...
\begin{center}
    \begin{tabularx}{\textwidth}{|c|c|c|c|c|X|}
        ...
        \hline
        1.1.0 & 26/01/2026 & L. Pellizzon & - & - & Modifica diagrammi UML Use Cases da UC1 a UC7, aggiunta Use Cases da UC8 a UC48 e modifica Attori \\
        \hline
...
\addScenarioPrincipale{L'\admin per caratteristiche un allarme:
\begin{itemize}
    \item seleziona il sensore (\rif{\Aa.1});
    \item seleziona il livello di priorità (\rif{\Aa.2});
    \item seleziona la soglia di intervento (\rif{\Aa.3});
    \item seleziona l'orario di attivazione (\rif{\Aa.4});
    \item seleziona l'orario di disattivazione (\rif{\Aa.5});
\end{itemize}
}
...
\addInclusione{\rif{\Aa.4}}
\addInclusione{\rif{\Aa.5}}
\makeUC[1]{\Aa}{Creazione allarme}

\addAttore{\admin}
\addPrC{L'\admin sta aggiungendo un nuovo allarme;}
\addPrC{Esistono sensori disponibili nel reparto selezionato.}
...
\addScenarioPrincipale{L'\admin seleziona il sensore da collegare all'allarme tra la lista dei sensori del reparto selezionato in precedenza}
\makeUC{\Aa.1}{Selezione sensore}
...
\makeUC{\Aa.2}{Selezione livello priorità allarme}
...
\makeUC{\Aa.3}{Selezione livello priorità allarme 1 (bianco)}
...
\makeUC{\Aa.4}{Selezione livello priorità allarme 2 (verde)}
...
\makeUC{\Aa.5}{Selezione livello priorità allarme 3 (arancione)}
...
\makeUC{\Aa.6}{Selezione livello priorità allarme 4 (rosso)}
...
\makeUC{\Aa.7}{Selezione soglia intervento allarme}
...
\makeUC{\Aa.8}{Selezione orario attivazione allarme}
...
\makeUC{\Aa.9}{Selezione orario disattivazione allarme}
...
\section{Requisiti}{
    ...
    \addReqF{2}{L'\admin deve selezionare il sensore per creare un allarme nel Sistema}{\rif{\Aa}\\\rif{\Aa.1}}
    ...
    \end{itemize}
    per creare un allarme nel Sistema}{\parbox[t]{\linewidth}{\rif{\Aa}\\\rif{\Aa.2}\\\rif{\Aa.3}\\\rif{\Aa.4}\\\rif{\Aa.5}\\\rif{\Aa.2.4}}}
    \addReqF{2}{L'\admin deve selezionare una soglia di intervetto per creare un allarme nel Sistema}{\rif{\Aa}\\\rif{\Aa.6}}
    \addReqF{2}{L'\admin deve selezionare un orario di attivazione per creare un allarme nel Sistema}{\rif{\Aa}\\\rif{\Aa.7}}
    \addReqF{2}{L'\admin deve selezionare un orario di disattivazione per creare un allarme nel Sistema}{\rif{\Aa}\\\rif{\Aa.8}}
