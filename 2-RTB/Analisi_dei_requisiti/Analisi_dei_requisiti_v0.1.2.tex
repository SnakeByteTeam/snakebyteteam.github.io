...
\trisubsection{UC1.4 Registrazione utente personale sanitario} \label{UC1.4}
\begin{center}
...
\addScenarioPrincipale{L'utente admin crea un nome utente per l'utente del personale sanitario;}
\addScenarioPrincipale{L'utente admin crea una password temporanea per l'utente del personale sanitario;}
\addScenarioPrincipale{Il nuovo utente del personale sanitario si autentica nel Sistema con le credenziali fornite dall'utente admin;}
\addScenarioPrincipale{L'utente del personale sanitario aggiorna la password.}
...
\addInclusione{Aggiornamento password utente personale sanitario \hyperref[UC1.4.1]{\textit{§UC1.4.1}}}

\makeTable


\trisubsection{UC1.4.1 Aggiornamento password utente personale sanitario} \label{UC1.4.1}

\addAttore{Utente personale sanitario}

\addPreCondizione{Il Sistema è attivo;}
\addPreCondizione{L'utente del personale sanitario è autenticato nel Sistema.}

\addPostCondizione{Il Sistema conosce la nuova password dell'utente del personale sanitario;}

\addScenarioPrincipale{L'utente del personale sanitario sceglie una nuova Password.}

\addTrigger{L'utete del personale sanitario si è autenticato con una password temporanea.}
...
\addScenarioPrincipale{L'utente visualizza la Dashboard;}
...
\addInclusione{Visualizzazione Dashboard \hyperref[UC2]{\textit{§UC2}}}
