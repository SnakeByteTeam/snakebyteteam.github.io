    ...
    \begin{center}
        ...
        \begin{center}
            \begin{tabular}{|c|c|c|c|}
                ...
                \hline
                1.0.3 & 12/12/2025 & Da verificare &       
                \begin{tabular}[c]{@{}l@{}}
...
\begin{center}
    \begin{tabularx}{\textwidth}{|c|c|c|c|c|X|}
        ...
        \hline
        1.0.3 & 12/12/2025 & V. Baleanu & L. Pellizzon & - & Aggiunta UC10 e UC10.1. Creazione diagrammi per UC3, UC3.3.1, UC3.3.2, UC3.6.1, UC3.6.2, UC3.7.1, UC3.7.2, UC3.10.\\
        \hline
...
\addScenarioAlternativo{Il Sistema non ha sufficienti dati per generare suggerimenti (\rif{7})}
\addEstensione{\rif{7}}
...
\addScenarioPrincipale{L'\os seleziona il periodo temporale da analizzare.}
\addScenarioAlternativo{Il Sistema non dispone di sufficenti dati per generare il grafico (\rif{7})}
\addEstensione{\rif{7}}
...
\addScenarioPrincipale{L'\os seleziona il periodo temporale da analizzare.}
\addScenarioAlternativo{Il Sistema non dispone di dati sufficienti per generare il grafico (\rif{7})}
\addEstensione{\rif{7}}
...
\addScenarioPrincipale{L'\os seleziona il periodo temporale da analizzare.}
\addScenarioAlternativo{Il Sistema non dispone di dati sufficienti (\rif{7})}
\addEstensione{\rif{7}}
