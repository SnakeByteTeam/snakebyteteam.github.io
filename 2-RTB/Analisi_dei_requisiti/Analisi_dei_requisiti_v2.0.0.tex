...
La prospettiva del prodotto è un Sistema domotico integrato per persone autosufficienti (ad esempio anziani) che si basa su dispositivi Vimar con connessione \textit{mesh Bluetooth}.
...
Tali risultati vengono raggiunti attraverso la centralizzazione del controllo di illuminazione, temperatura, televisione e dispositivi di sicurezza mediante l'app View e i relativi servizi \textit{cloud}, con la possibilità di controllo da remoto da parte del personale medico.
...
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestioni delle informazioni della dashboard;}
...
\addAttore{\admin}
\addPrC{L'\admin sta creando un nuovo allarme.}
\addPoC{Le la soglia di intervento è configurato per l'allarme che si vuole creare.}
