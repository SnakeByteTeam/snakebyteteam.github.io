    ...
    \begin{center}
        ...
        \begin{center}
            \begin{tabular}{|c|c|c|c|}
                ...
                \hline
                0.2.0 & 06/12/2025 & Verificato & SnakeByte, prof. Vardanega Tullio, prof. Cardin Riccardo \\
                \hline
            \end{tabular}
        \end{center}
        \vfill
...
\begin{tabularx}{\textwidth}{|c|c|c|c|c|X|}
    ...
    \hline
    0.2.0 & 06/12/2025 & C. Libralato & L. Pellizzon & - & Aggiunte a processo di verifica e approvazione (sez. 3.1.4, 3.1.5). Aggiunta Sviluppo con Analisi Requisiti ai processi primari (sez. 2.2 )\\ 
    \hline
...
\begin{enumerate}
    ...
    Per costruzione, le modifiche contemporanee su documenti diversi dovranno essere presentate attraverso branch di modifica e pull request diverse.
...
\begin{enumerate}
    ...
    Viene effettuata la \textit{push} e aperta una \textit{pull request} verso il branch \texttt{develop}. Devono essere impostati i \textit{tag}
    e l'assegnatario deve essere il responsabile.
