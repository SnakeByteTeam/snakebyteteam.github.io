    ...
    \begin{center}
        ...
        \begin{center}
            \begin{tabular}{|c|c|c|c|}
                ...
                \hline
                0.1.5 & 8/11/2025 & Da verificare & SnakeByte, prof. Tullio Vardanega, prof. Riccardo Cardin\\
                \hline
            \end{tabular}
        \end{center}
        \vfill
...
Tale strumento garantisce che nessuna modifica venga integrata nel \textit{branch} principale (\texttt{develop}) senza un controllo esplicito del verificatore,
...
Di seguito viene dettagliato il \textit{workflow} operativo:
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        e procede al \textit{merge} automatico del branch. \\ Il processo di verifica è concluso.
...
Ogni documento, dopo essere stato approvato, deve essere approvato per poter essere rilasciato sulla documentazione ufficiale del progetto.
