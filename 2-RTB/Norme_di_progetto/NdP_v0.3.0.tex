...
\trisubsection{MPC10 - Indice di Gulpease (IG)}
\Metrica{MPC10}
...
\trisubsection{MPC11 - Indice di Frammentazione (IF)}
\Metrica{MPC11}
...
\trisubsection{MPC12 - Test Success Rate (TSR)}
\Metrica{MPC12}
...
\trisubsection{MPC13 - Percentuale Metriche Soddisfatte (PMS)}
\Metrica{MPC13}
...
\trisubsection{MPC14 - Percentuale Rischi Inattesi (PRI)}
\Metrica{MPC14}
...
\trisubsection{MPC15 - Labor Efficiency (LE)}
\Metrica{MPC15}
