...
da un codice univoco nella forma \textit{MPCX}, dove \textit{X} rappresenta 
...
mentre valori superiori a 1 suggeriscono risparmi potenziali.}
...
\Metrica{MPC16}
{Percentuale di rischi non previsti in fase di analisi iniziale che si sono manifestati
...
Dove:
\begin{itemize}
    \item $R_{inattesi}$ = Numero di rischi non previsti che si sono verificati;
...
\\Ogni metrica è identificata da un codice univoco nella forma \textit{MPDX}, dove \textit{X} rappresenta 
un numero intero progressivo.
...
di reperimento di informazioni, senza supporto esterno.}
...
\end{itemize}}
{Valuta l'intuitività dell'interfaccia nella ricerca e consultazione delle 
informazioni.}
...
\trisubsection{MPD11 - Compatibilità Cross-Browser (CCB)}
\Metrica{MPD11}
