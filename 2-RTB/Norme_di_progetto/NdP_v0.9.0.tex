...
\begin{itemize}
    ...
    \item registrare gli esiti delle attività di Quality Assurance;
...
Il gruppo \textit{SnakeByte} adotta il modello di sviluppo iterativo basato su \textit{sprint$_{G}$} di durata fissa pari a due settimane. Ogni \textit{sprint} si articola nelle seguenti fasi:
...
Le \textit{Issue} vengono organizzate all'interno di una \textit{board$_{G}$} di progetto che visualizza lo stato di avanzamento attraverso le seguenti colonne:
...
Ogni membro del gruppo è tenuto ad aggiornare lo stato delle proprie \textit{Issue} con regolarità, spostando le carte tra le colonne in base all'avanzamento del lavoro e commentando eventuali difficoltà o variazioni rispetto alla pianificazione.
