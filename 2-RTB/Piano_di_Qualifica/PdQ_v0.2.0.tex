...
\sogliatabella{
    \sogliariga{MPC10}{Indice di Gulpease}{$\geq 60$}{$\geq 80$}
    \sogliariga{MPC11}{Indice di Frammentazione (IF)}{$5\% \leq IF \leq 20\%$}{$10\% \leq IF \leq 15\%$}
}

\subsubsection{Verifica}
\sogliatabella{
    \sogliariga{MPC12}{Test Success Rate}{$\geq 80\%$}{$100\%$}
}

\subsubsection{Gestione della qualità}
\sogliatabella{
    \sogliariga{MPC13}{Percentuale Metriche Soddisfatte}{$\geq 80\%$}{$100\%$}
}

\subsection{Processi organizzativi}
\subsubsection{Gestione dei processi}
\sogliatabella{
    \sogliariga{MPC14}{Percentuale Rischi Inattesi}{$\leq 20\%$}{$0\%$}
    \sogliariga{MPC15}{Labor Efficiency}{$\geq 70\%$}{$\geq 100\%$}
}
