...
\subsection{Sprint 9 (23/02/2026 - 8/03/2026)}
\subsubsection{Avanzamento}
\trisubsection{Attività programmate}
Si prevede l'esecuzione delle seguenti attività:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \rif{RO8} (non previsto) - Sottostima costi e ore: come si può evincere dalle seguenti tabelle, le stime orarie sono state errate. In particolare il preventivo risulta in difetto di 7 ore, 63 ore reali svolte al fronte di 56 preventivate.
\end{itemize}
...
\subsubsection{Retrospettiva}
Durante lo \textit{sprint} 9 il gruppo si ritiene soddisfatto del lavoro svolto, soprattutto in seguito all'approvazione della \textit{baseline} relativa alla \textit{milestone} RTB. 
...
Dal punto di vista organizzativo rimane leggermente problematica la previsione degli orari, che rivela talvolta sottostimata o sovrastimata. 
