...
Prima di eseguire i comandi descritti nelle sezioni successive, assicurarsi di avere \textit{Node.js} installato. Successivamente, aprire un terminale nella \textit{directory} radice del sistema ed eseguire:
\begin{verbatim}
npm install
\end{verbatim}
...
\begin{enumerate}
    \item Aprire il \textit{browser} supportato (vedere Sezione~\ref{sec:browsers});
