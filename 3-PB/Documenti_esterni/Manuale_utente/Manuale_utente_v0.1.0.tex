...
\begin{enumerate}
    ...
    \item Il Sistema registra il collegamento e mostra l'indirizzo email 
          dell'account MyVimar collegato.
            \centering
            \includegraphics[width=0.8\textwidth]{./img/utente_collegato_myVimar.png}\end{enumerate}
...
\begin{enumerate}
    \item Dal menu principale, selezionare la voce \textbf{Notifiche}.
      \centering
      \includegraphics[width=0.5\textwidth]{./img/voce_notifiche.png}
...
\begin{enumerate}
    \item Dal menu principale, selezionare la voce \textbf{Dispositivi};
      ...
      \item Il Sistema mostra l'elenco dei dispositivi suddivisi per stanza.\\ 
          ...
          \end{itemize}
           \centering
            \includegraphics[width=0.9\textwidth]{./img/elenco_dispositivi.png}
\end{enumerate}
