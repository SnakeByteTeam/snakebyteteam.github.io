...
\addChangelog{0.2.3}{04/04/2026}{F. Venzo}{G. De Fina}{\noOne}{Modifica sezione specifiche hardware e installazione}
\addChangelog{0.2.2}{04/04/2026}{V. Baleanu}{G. De Fina}{\noOne}{Aggiunta sezione riferimento API}
\addChangelog{0.2.1}{03/04/2026}{V. Baleanu}{G. De Fina}{\noOne}{Aggiunta sezione test}
\addChangelog{0.2.0}{02/04/2026}{L. Granziero}{G. De Fina}{\noOne}{Schermate di gestione, configurazione allarmi}
\addChangelog{0.1.0}{01/04/2026}{L. Granziero}{G. De Fina}{\noOne}{\firstDraft}
\makeChangelog
...
\begin{itemize}
    ...
    \item \textbf{Requisiti}: una definizione di quelli che sono i requisiti minimi di \textit{browser} per poter correttamente eseguire il Sistema;
...
\begin{itemize}
    \item \textbf{Analisi dei Requisiti 2.0.0}:
      \\ \url{https://snakebyteteam.github.io/2-RTB/Documenti_esterni/Analisi_dei_requisiti/Analisi_dei_Requisiti_v2.0.0.pdf} 
      \\ (consultato il 05/04/2026).
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{img/eliminazione_os.png}
    ...
    \item Il Sistema rimuove l'Operatore Sanitario dal reparto e aggiorna 
