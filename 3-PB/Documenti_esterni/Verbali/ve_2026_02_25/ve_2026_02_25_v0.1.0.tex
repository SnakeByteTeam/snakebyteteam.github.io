%============================
% Verbale riunione – Progettazione e pianificazione Sprint 9
%============================
...
\begin{itemize}
  \item Avanzamento progetto e pianificazione Sprint$_G$ 9;
  \item scelte tecnologiche e stato della progettazione;
  \item gestione allarmi, dashboard e ruoli utente;
  \item requisiti di compatibilità browser e supporto mobile;
  \item organizzazione attività future.
...
È stato illustrato lo stato di avanzamento del progetto, aggiornando la Proponente sulle attività svolte, sulla pianificazione dello sprint corrente e sulla preparazione della presentazione per la Requirements and Technology Baseline (RTB). In particolare, è stata presentata l'assegnazione dei ruoli per lo Sprint 9, evidenziando la presenza di quattro progettisti.
\noindent
...
\noindent
È stata inoltre confermata l’adozione di \textit{NestJS$_G$} in sostituzione di \textit{Express$_G$}, e l’utilizzo di \textit{PostgreSQL$_G$} come database relazionale principale, affiancato da \textit{TimescaleDB$_G$} per la gestione efficiente delle serie temporali. In particolare, è stata illustrata la progettazione di una hypertable per la memorizzazione dei dati di consumo energetico, basata sull’associazione tra timestamp e dispositivo.
\noindent
...
\noindent
È stato inoltre suggerito di considerare come requisito minimo la prima versione disponibile nel 2026 per ciascun browser supportato, al fine di garantire chiarezza nella documentazione e coerenza con i requisiti progettuali.
\noindent
...
\subsection{Organizzazione attività future}
Il gruppo ha discusso la preparazione della presentazione per la RTB, con particolare attenzione alla gestione documentale, alla pianificazione e alla presentazione delle scelte progettuali effettuate.
\noindent
...
\addTodo{-}{Raffinare il modello ER, chiarendo le relazioni tra unità, appartamenti e dispositivi.}{V. Baleanu, G. De Fina, F. Pasqual, F. Venzo}{28/02/2026}

\addTodo{-}{Definire e presentare lo schema di gestione dei dati per TimescaleDB.}{V. Baleanu, G. De Fina, F. Pasqual, F. Venzo}{04/03/2026}
