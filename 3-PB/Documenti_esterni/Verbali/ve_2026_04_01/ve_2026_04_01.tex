...
\begin{itemize}
      ...
      \item preparazione al Collaudo e Deliverable di Progetto;
...
È stata esposta l'implementazione delle analytics e dei suggerimenti tramite il modello Grok, spiegando la logica di caching, la periodicità di aggiornamento.
Il modello Grok viene utilizzato per generare suggerimenti gratuiti, con limiti di 30 richieste al minuto e 14.000 al giorno, integrando i suggerimenti direttamente nelle analytics inviate dal backend al frontend.
I suggerimenti sono inclusi nelle analytics, la generazione di entrambi avviene on demand tramite trigger sull'accesso alla sezione Analytics, con caching gestito da nginx per utente e Plant ID,
...
Si è discussa la necessità di rinegoziare alcuni requisiti opzionali, proponendo di rendere la dashboard fissa e non personalizzabile, limitare l'interazione in scrittura con i dispositivi 
e rimuovere la mappa degli allarmi.
...
\subsection*{Preparazione al Collaudo e Deliverable di Progetto}
Sono state illustrate le modalità di collaudo, i deliverable richiesti e le aspettative per la presentazione finale, specificando la necessità di mostrare l'avanzamento, la demo, l'architettura (modello C4), la timeline e una retrospettiva, con indicazioni sulla gestione dei bozzetti e dei manuali utente.
...
Si è poi discussa la scelta tra grafici a barre e a punti per le diverse analytics, concordando sulla visualizzazione in base alla continuità dei dati e sull'inserimento di selettori e indicazioni temporali del periodo di riferimento dei dati.
...
\addDecision{Riduzione requisiti opzionali, con mantenimento di dashboard statica, limitazione scrittura dei dispositivi e rimozione mappa allarmi}
\makeDecisionTable
