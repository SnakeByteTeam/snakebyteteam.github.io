...
\newcommand\Am{18} % Aggiunta modulo alla dashboard
\newcommand\Amsa{19} % Aggiunta modulo statistiche allarmi
\newcommand\Amiu{20} % Aggiunta modulo informazioni Utente
\newcommand\Amacl{21} % Aggiunta modulo analisi clima
\newcommand\Amaco{22} % Aggiunta modulo analisi consumi

\newcommand\Rm{23} % Rimozione modulo alla dashboard
\newcommand\Rmsa{24} % Rimozione modulo statistiche allarmi
\newcommand\Rmiu{25} % Rimozione modulo informazioni Utente
\newcommand\Rmacl{26} % Rimozione modulo analisi clima
\newcommand\Rmaco{27} % Rimozione modulo analisi consumi

\newcommand\Ra{28} % Risoluzione allarme

\newcommand\Va{29} % Visualizzazione analytics

\newcommand\Vap{30} % Visualizzazione Appartamento

\newcommand\Aapp{31} % Abilita appartamento
\newcommand\Dapp{32} % Disabilita appartamento

\newcommand\Aa{33} % Aggiunta allarme
\newcommand\Mpa{34} % Modifica priorità allarme
\newcommand\Msia{35} % Modifica soglia intervento allarme
\newcommand\Moaa{36} % Modifica orario attivazione allarme
\newcommand\Moda{37} % Modifica orario disattivazione allarme
\newcommand\Aal{38} % Abilita allarme
\newcommand\Dal{39} % Disabilita allarme
\newcommand\Ea{40} % Elimina allarme

\newcommand\Vn{41} % Visualizzazione notifiche

\newcommand\Erunr{42} % Errore username non registrato o password errata
\newcommand\Erpte{43} % Errore username non registrato o password temporanea errata
\newcommand\Ernpupt{44} % Errore nuova password è uguale alla password temporanea
\newcommand\Ernpnv{45} % Errore nuova password non valida
\newcommand\Eruu{46} % Errore username già in uso
\newcommand\Ernru{47} % Errore nome reparto già in uso
\newcommand\Erns{48} % Errore nessun sensore selezionato
\newcommand\Ernlp{49} % Errore nessun livello di priorità selezionato
\newcommand\Ernss{50} % Errore nessun soglia di intervento selezionata
...
\begin{center}
    \begin{xltabular}{\textwidth}{|c|c|c|c|c|X|}
        ...
        \hline
        3.0.0 & 05/04/2026 & - & - & C. Libralato & Approvazione \\
        \hline
        2.1.0 & 26/02/2026 & L. Pellizon & C. Libralato & - & Sistemazioni degli erori emersi durante alla candidatura alla revisione RTB \\
        \hline
        2.0.0 & 10/02/2026 & - & - & F. Venzo & Approvazione \\
        \hline
        1.1.2 & 09/02/2026 & L. Pellizzon & F. Pasqual & - & Rivisitazione delle pre e post condizioni di tutti gli Use Cases, correzione errori di sintassi \\
        \hline
        1.1.1 & 02/02/2026 & L. Pellizzon & V. Baleanu & - & Modifica diagramma UML Use Cases UC31 \\
        \hline
...
\subsection{Finalità del documento}{
    ...
    \begin{itemize}
        \item Il documento Analisi dei Requisiti serve come input per la progettazione del Sistema, per la pianificazione dello sviluppo e per la pianificazione dei test.
...
\begin{itemize}
    ...
    \item \textbf{Glossario}
          \\ \url{https://snakebyteteam.github.io/2-RTB/Documenti_interni/Glossario/glossario_v1.0.0.pdf}
          \\ (consultato il 10/02/2026).
\end{itemize}

\section{Descrizione del prodotto}
\subsection{Prospettiva del prodotto}
La prospettiva del prodotto è un Sistema domotico integrato per persone autosufficienti (ad esempio anziani) che si basa su dispositivi
Vimar con connessione \textit{mesh Bluetooth}. Gli obiettivi principali sono la sicurezza e il comfort delle persone occupanti, l'aumento
dell'efficienza energetica della struttura e la semplificazione della gestione operativa dell'impianto elettrico. Tali risultati vengono
raggiunti attraverso la centralizzazione del controllo di illuminazione, temperatura, televisione e dispositivi di sicurezza mediante l'app
View e i relativi servizi \textit{cloud}, con la possibilità di controllo da remoto da parte degli operatori sanitari.

\subsection{Obiettivi del prodotto}{
    Il progetto consiste nella realizzazione di una piattaforma unica \textit{View4Life} per la gestione intelligente degli impianti
    \textit{Smart} nelle residenze protette, sfruttando i dispositivi domotici Vimar connessi in rete \textit{mesh Bluetooth} che
    vengono poi esposti tramite l'interfaccia \textit{API KNX IoT 3rd-party$_{G}$}. Questa soluzione mira a supportare il lavoro del
    \os fornendo uno strumento che integri un Sistema di gestione degli allarmi (come il rilevamento di cadute o presenze prolungate
    in determinate stanze) per garantire un intervento rapido e tempestivo. Inoltre, la piattaforma è progettata per permettere il
    monitoraggio del consumo energetico e la rilevazione di anomalie nell’impianto (ad esempio le disconnessioni).
}
...
\begin{itemize}
    ...
    \item Possibilità di visualizzare statistiche, tramite grafici, sui consumi dell'impianto, sulla variazione di temperatura e sugli
          allarmi passati;
...
\subsection{Utenza di riferimento}{
    Il prodotto si rivolge a due categorie di utenti:
    \begin{itemize}
        \item \textbf{Operatori sanitari} che utilizzano l'applicazione per monitorare lo stato di ambienti e dispositivi, oltre a ricevere notifiche di allarme e gestire da remoto funzioni come temperatura, illuminazione e sicurezza delle stanze degli ospiti presenti.
    ...
    Attraverso l’app View e i servizi \textit{cloud} Vimar, l’applicazione permette di gestire in modo integrato illuminazione, temperatura e sicurezza, contribuendo a maggior efficienza energetica, sicurezza e comfort abitativo per tutti gli utenti coinvolti.
}
...
\begin{center}
    \begin{xltabular}{\textwidth}{|c| >{\centering\arraybackslash}X|}
        \hline
        ...
        \hline
        \caption{Descrizione dei campi associati ai casi d'uso}
    \end{xltabular}
\end{center}
...
Di seguito vengono riportati gli attori principali individuati:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.415\textwidth]{./img/Attoripri.pdf}
...
Di seguito vengono riportati gli attori secondari individuati:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.325\textwidth]{./img/Attorisec.pdf}
    \caption{Diagramma attori secondari}
    \label{fig:attori}
\end{figure}
...
\addPrC{L'\user si trova nella pagina di autenticazione.}
\addPoC{L'\user è autenticato nel Sistema;}
\addPoC{L'\user è riconosciuto dal Sistema come \os o \admin.}
...
\addScenarioPrincipale{L'\user conferma l'operazione.}
...
\addAttore{\user}
\addPrC{Il Sistema è attivo;}
\addPrC{L'\user si trova nella pagina di autenticazione con cambio password.}
\addPoC{L'\user è autenticato nel Sistema;}
\addPoC{L'\user è riconosciuto dal Sistema come \os.}
...
\makeUC[0.825]{\Aucp}{Autenticazione con cambio password}
...
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione dell'account MyVimar;}
\addScenarioPrincipale{L'\admin visualizza se è presente un account MyVimar collegato.}
\addInclusione{\rif{\VaMV.1}}
\makeUC{\VaMV}{Visualizzazione account MyVimar collegato}

\addAttore{\admin}
\addPrC{L'\admin sta visualizzando l'account MyVimar collegato.}
\addPoC{L'\admin visualizza la email dell'account MyVimar collegato.}
\addScenarioPrincipale{L'\admin visualizza la email dell'account MyVimar collegato.}
\makeUC{\VaMV.1}{Visualizzazione email}
...
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione dell'account MyVimar;}
\addScenarioPrincipale{L'\admin viene reindirizzato al portale di Vimar per collegare l'account
    segue la procedura.}
\makeUC[0.633]{\CaMV}{Collegamento account MyVimar}

\addAttore{\admin}
\addAttoreSec{\cloud}
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema.}
\addPoC{Il Sistema rimuove le credenziali dell'account MyVimar dalla propria configurazione.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione dell'account MyVimar;}
\addScenarioPrincipale{L'\admin rimuove l'account MyVimar collegato.}
\makeUC[0.633]{\RaMV}{Rimozione account MyVimar}
...
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema.}
\addPoC{L'\admin visualizza l'elenco degli utenti.}
...
\makeUC{\Vu}{Visualizzazione elenco utenti}

\addPrC{L'\admin sta visualizzando l'elenco di tutti gli utenti.}
\addPoC{L'\admin visualizza un singolo utente con le proprie informazioni.}
\addScenarioPrincipale{L'\admin visualizza un singolo utente con le proprie informazioni:
    \begin{itemize}
        \item nome dell'utente (\rif{\Vu.1.1});
        \item cognome dell'utente (\rif{\Vu.1.2});
        \item l'username dell'utente (\rif{\Vu.1.3}).
    \end{itemize}
}
...
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione utenti;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla creazione di un nuovo utente;}
...
\addScenarioPrincipale{L'\admin genera la password temporanea (\rif{\Cu.4});}
\addScenarioPrincipale{L'\admin conferma l'operazione.}
...
\makeUC[0.825]{\Cu}{Creazione nuovo utente \os}

\addAttore{\admin}
\addPrC{L'\admin sta creando un nuovo utente \os.}
\addPoC{Il Sistema conosce il nome del del nuovo utente \os.}
\addScenarioPrincipale{L'\admin inserisce il nome per l'utente \os che vuole creare.}
\makeUC{\Cu.1}{Inserimento nome}

\addAttore{\admin}
\addPrC{L'\admin sta creando un nuovo utente \os.}
\addPoC{Il Sistema conosce il cognome del nuovo utente \os.}
\addScenarioPrincipale{L'\admin inserisce il cognome per l'utente \os che vuole creare.}
\makeUC{\Cu.2}{Inserimento cognome}

\addAttore{\admin}
\addPrC{L'\admin sta creando un nuovo utente \os.}
\addPoC{Il Sistema conosce lo username del nuovo utente \os.}
\addScenarioPrincipale{L'\admin inserisce un username per l'utente \os che vuole creare.}
\makeUC{\Cu.3}{Inserimento username}

\addAttore{\admin}
\addPrC{L'\admin sta creando un nuovo utente \os.}
\addPoC{Il Sistema conosce la password temporanea del nuovo utente \os.}
\addScenarioPrincipale{L'\admin genera una password temporanea per l'utente \os che vuole creare.}
\makeUC{\Cu.4}{Generazione password temporanea}

\addAttore{\admin}
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{L'\os che si vuole eliminare esiste nel Sistema.}
\addPoC{L'utente del \os è eliminato dal Sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione utenti;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla eliminazione di un utente;}
\addScenarioPrincipale{L'\admin elimina l'utente \os.}
\makeUC{\Eu}{Eliminazione utente \os}
...
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema.}
\addPoC{L'\admin visualizza l'elenco dei reparti.}
...
\makeUC{\Vr}{Visualizzazione elenco reparti}

\addAttore{\admin}
\addPrC{L'\admin sta visualizzando l'elenco dei reparti.}
\addPoC{L'\admin visualizza un singolo reparto con le proprie informazioni.}
...
\addPoC{L'\admin visualizza il nome del reparto.}
\addScenarioPrincipale{L'\admin visualizza il nome del reparto.}
\makeUC{\Vr.1.1}{Visualizzazione nome}

\addAttore{\admin}
\addPrC{L'\admin sta visualizzando un reparto.}
\addPoC{L'\admin visualizza l'elenco degli appartamenti.}
...
\addPoC{L'\admin visualizza un singolo appartamento con le proprie informazioni.}
...
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione reparti;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa all'inserimento di un reparto;}
...
\makeUC[0.825]{\Cr}{Creazione reparto}
...
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{Il reparto che si vuole modificare esiste nel sistema.}
\addPoC{Il nome del reparto viene aggiornato dal Sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione reparti;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla modifica di un reparto;}
\addScenarioPrincipale{L'\admin modifica il nome del reparto;}
\addScenarioPrincipale{L'\admin conferma l'operazione.}
\makeUC{\Mr}{Modifica nome reparto}

\addAttore{\admin}
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{Il reparto che si vuole eliminare esiste nel Sistema.}
\addPoC{Il reparto viene eliminato dal Sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione reparti;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa all'eliminazione di un reparto;}
\addScenarioPrincipale{L'\admin elimina il reparto.}
\makeUC{\Er}{Eliminazione reparto}
...
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione reparti.}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa all'inserimento di un'assegnazione utente \os - reparto;}
...
\makeUC{\Aaosr}{Aggiunta assegnazione utente \os - reparto}

\addAttore{\admin}
\addPrC{L'\admin sta aggiungendo un'assegnazione utente \os - reparto.}
\addPoC{Il Sistema conosce il reparto che verrà assegnato all'utente \os.}
...
\addScenarioPrincipale{L'\admin seleziona l'utente \os.}
\makeUC{\Aaosr.2}{Selezione utente \os}

\addAttore{\admin}
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{L'assegnazione utente \os - reparto che si vuole rimuovere esiste nel Sistema.}
\addPoC{L'assegnazione utente \os - reparto viene rimossa dal Sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione reparti;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla rimozione di un'assegnazione utente \os - reparto;}
\addScenarioPrincipale{L'\admin rimuove l'assegnazione utente \os - reparto.}
\makeUC{\Raosr}{Rimozione assegnazione utente \os - reparto}
...
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione reparti;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa all'aggiunta di un'assegnazione appartamento - reparto;}
...
\makeUC{\Aaapr}{Aggiunta assegnazione appartamento - reparto}

\addAttore{\admin}
\addPrC{L'\admin sta aggiungendo un'assegnazione appartamento - reparto.}
\addPoC{Il Sistema conosce il reparto che verrà assegnato l'appartamento.}
\addScenarioPrincipale{L'\admin seleziona il reparto.}
...
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{L'assegnazione appartamento - reparto che si vuole rimuovere esiste nel Sistema;}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione reparti;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla assegnazione di un'assegnazione appartamento - reparto;}
...
\makeUC{\Raapr}{Rimozione assegnazione appartamento - reparto}
...
\makeUC[0.633]{\Vd}{Visualizzazione dashboard}
...
\addAttore{\user}
\addPrC{L'\user sta visualizzando il modulo gestione allarmi.}
...
\addAttore{\user}
\addPrC{L'\user sta visualizzando un allarme.}
...
\addPoC{L'\user visualizza il numero di allarmi risolti.}
\addScenarioPrincipale{L'\user visualizza il numero di allarmi risolti.}
\makeUC{\Vd.2.1}{Visualizzazione numero di allarmi risolti}

\addAttore{\user}
\addPrC{L'\user sta visualizzando statistiche allarmi.}
\addPoC{L'\user visualizza il numero di allarmi attivi.}
\addScenarioPrincipale{L'\user visualizza il numero di allarmi attivi.}
\makeUC{\Vd.2.2}{Visualizzazione numero di allarmi attivi}
...
\addAttore{\user}
\addPrC{L'\user sta visualizzando la dashboard.}
\addPoC{L'\user visualizza il grafico che riporta l'andamento della temperatura espressa in gradi Celsius negli ultimi 30 giorni.}
\addScenarioPrincipale{L'\user visualizza il grafico che riporta l'andamento della temperatura negli ultimi 30 giorni.}
...
\addAttore{\user}
\addPrC{L'\user sta visualizzando la dashboard.}
\addPoC{L'\user visualizza il grafico che riporta l'andamento dei consumi espressi in watt negli ultimi 30 giorni.}
\addScenarioPrincipale{L'\user visualizza il grafico che riporta l'andamento dei consumi negli ultimi 30 giorni.}
...
\addAttore{\user}
\addPrC{L'\user sta visualizzando la dashboard.}
\addPoC{L'\user visualizza il grafico che riporta l'andamento della presenza negli ultimi 30 giorni.}
\addScenarioPrincipale{L'\user visualizza il grafico che riporta l'andamento della presenza negli ultimi 30 giorni.}
...
\addPoC{Il Sistema aggiunge alla visualizzazione della dashboard il modulo selezionato.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione delle informazioni della dashboard;}
\addScenarioPrincipale{L'\admin aggiunge alla visualizzazione il modulo selezionato.}
\addGeneralizzazione{\rif{\Amsa}}
\addGeneralizzazione{\rif{\Amiu}}
\addGeneralizzazione{\rif{\Amacl}}
\addGeneralizzazione{\rif{\Amaco}}
\makeUC[0.6]{\Am}{Aggiunta modulo alla dashboard}

\addAttore{\admin}
\addPrC{L'\admin si trova nella sezione dashboard.}
\addPoC{Il Sistema aggiunge alla visualizzazione della dashboard il modulo statistiche allarmi.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione delle informazioni della dashboard;}
\addScenarioPrincipale{L'\admin aggiunge alla visualizzazione il modulo statistiche allarmi.}
\makeUC{\Amsa}{Aggiunta modulo statistiche allarmi}

\addAttore{\admin}
\addPrC{L'\admin si trova nella sezione dashboard.}
\addPoC{Il Sistema aggiunge alla visualizzazione della dashboard il modulo informazioni \user}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione delle informazioni della dashboard;}
\addScenarioPrincipale{L'\admin aggiunge alla visualizzazione il modulo informazioni \user}
\makeUC{\Amiu}{Aggiunta modulo informazioni \user}

\addAttore{\admin}
\addPrC{L'\admin si trova nella sezione dashboard.}
\addPoC{Il Sistema aggiunge alla visualizzazione della dashboard il modulo analisi clima.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione delle informazioni della dashboard;}
\addScenarioPrincipale{L'\admin aggiunge alla visualizzazione il modulo analisi clima.}
\makeUC{\Amacl}{Aggiunta modulo analisi clima}

\addAttore{\admin}
\addPrC{L'\admin si trova nella sezione dashboard.}
\addPoC{Il Sistema aggiunge alla visualizzazione della dashboard il modulo analisi consumi.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione delle informazioni della dashboard;}
\addScenarioPrincipale{L'\admin aggiunge alla visualizzazione il modulo analisi consumi.}
\makeUC{\Amaco}{Aggiunta modulo analisi consumi}

\addAttore{\admin}
\addPrC{L'\admin si trova nella sezione dashboard.}
\addPoC{Il Sistema rimuove dalla visualizzazione il modulo selezionato.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione delle informazioni della dashboard;}
\addScenarioPrincipale{L'\admin rimuove dalla visualizzazione il modulo selezionato.}
\addGeneralizzazione{\rif{\Rmsa}}
\addGeneralizzazione{\rif{\Rmiu}}
\addGeneralizzazione{\rif{\Rmacl}}
\addGeneralizzazione{\rif{\Rmaco}}
\makeUC[0.6]{\Rm}{Rimozione modulo dalla dashboard}

\addAttore{\admin}
\addPrC{L'\admin si trova nella sezione dashboard.}
\addPoC{Il Sistema rimuove dalla visualizzazione della dashboard il modulo statistiche allarmi.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione delle informazioni della dashboard;}
\addScenarioPrincipale{L'\admin rimuove dalla visualizzazione il modulo statistiche allarmi.}
\makeUC{\Rmsa}{Rimozione modulo statistiche allarmi}

\addAttore{\admin}
\addPrC{L'\admin si trova nella sezione dashboard.}
\addPoC{Il Sistema rimuove dalla visualizzazione della dashboard il modulo informazioni \user}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione delle informazioni della dashboard;}
\addScenarioPrincipale{L'\admin rimuove dalla visualizzazione il modulo informazioni \user}
\makeUC{\Rmiu}{Rimozione modulo informazioni \user}

\addAttore{\admin}
\addPrC{L'\admin si trova nella sezione dashboard.}
\addPoC{Il Sistema rimuove dalla visualizzazione della dashboard il modulo analisi clima.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione delle informazioni della dashboard;}
\addScenarioPrincipale{L'\admin rimuove dalla visualizzazione il modulo analisi clima.}
\makeUC{\Rmacl}{Rimozione modulo analisi clima}

\addAttore{\admin}
\addPrC{L'\admin si trova nella sezione dashboard.}
\addPoC{Il Sistema rimuove nella visualizzazione della dashboard il modulo analisi consumi.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione delle informazioni della dashboard;}
\addScenarioPrincipale{L'\admin rimuove dalla visualizzazione il modulo analisi consumi.}
\addPrC{L'\admin si trova nella sezione dashboard.}
\makeUC{\Rmaco}{Rimozione modulo analisi consumi}

\addAttore{\user}
\addPrC{L'\user si trova nella sezione dashboard.}
\addPoC{Il Sistema contrassegna l'allarme come risolto.}
\addScenarioPrincipale{L'\user contrassegna l'allarme come risolto.}
\makeUC{\Ra}{Risoluzione allarme}
...
\addScenarioPrincipale{L'\user seleziona dal menù l'opzione relativa alla visualizzazione analytics;}
\addScenarioPrincipale{L'\user seleziona l'appartamento del quale vuole vedere le analytics;}
...
\makeUC[0.633][0.55]{\Va}{Visualizzazione analytics}
...
\addPrC{Il Sistema è attivo;}
\addPrC{L'\user è autenticato nel Sistema.}
\addPoC{L'\user visualizza un appartamento con le proprie informazioni.}
\addScenarioPrincipale{L'\user seleziona dal menù l'opzione visualizza appartamento relativa all'appartamento che vuole visualizzare;}
...
\makeUC[0.633]{\Vap}{Visualizzazione appartamento}
...
\addAttore{\user}
\addPrC{L'\user sta visualizzando un appartamento.}
\addPoC{L'\user visualizza la mappa degli allarmi dell'appartamento.}
\addScenarioPrincipale{L'\user visualizza la mappa degli allarmi dell'appartamento.}
...
\addAttore{\user}
\addPrC{L'\user sta visualizzando la lista dei dispositivi di una stanza.}
\addPoC{L'\user visualizza un dispositivo con le proprie informazioni.}
%\addTrigger{L'\os vuole visualizzare il termostato dell'impianto.}
\addScenarioPrincipale{L'\user visualizza le caratteristiche relative al singolo dispositivo:
    \begin{itemize}
        \item il nome (\rif{\Vap.3.1.2.1.1});
        \item lo stato corrente (\rif{\Vap.3.1.2.1.2});
...
\addGeneralizzazione{\rif{\Vap.3.1.2.2}}
\addGeneralizzazione{\rif{\Vap.3.1.2.3}}
\addGeneralizzazione{\rif{\Vap.3.1.2.4}}
\addGeneralizzazione{\rif{\Vap.3.1.2.5}}
\addGeneralizzazione{\rif{\Vap.3.1.2.6}}
\addGeneralizzazione{\rif{\Vap.3.1.2.7}}
\addGeneralizzazione{\rif{\Vap.3.1.2.8}}
\makeUC[0.715]{\Vap.3.1.2.1}{Visualizzazione elemento elenco dispositivi}
...
\addAttore{\user}
\addPrC{L'\user sta visualizzando la lista dei dispositivi di una stanza.}
\addPoC{L'\user visualizza un termostato con le proprie informazioni.}
%\addTrigger{L'\os vuole visualizzare il termostato dell'impianto.}
...
\addAttore{\user}
\addPrC{L'\user sta visualizzando la lista dei dispositivi di una stanza.}
\addPoC{L'\user visualizza un sensore di caduta con le proprie informazioni.}
...
\makeUC{\Aapp}{Abilita appartamento}
...
\makeUC{\Dapp}{Disabilita appartamento}
...
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione allarmi;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa all'inserimento di un nuovo allarme;}
...
\addScenarioPrincipale{L'\admin seleziona l'appartamento per l'allarme che vuole creare.}
...
%\addTrigger{L'\admin deve selezionare un sensore per l'allarme.}
\addScenarioPrincipale{L'\admin seleziona il sensore per l'allarme che vuole creare.}
...
\addGeneralizzazione{\rif{\Aa.4}}
\addGeneralizzazione{\rif{\Aa.5}}
\addGeneralizzazione{\rif{\Aa.6}}
\addGeneralizzazione{\rif{\Aa.7}}
\makeUC[0.6]{\Aa.3}{Selezione livello priorità allarme}
...
\addAttore{\admin}
\addPrC{L'\admin sta creando un nuovo allarme.}
\addPoC{La soglia di intervento è configurato per l'allarme che si vuole creare.}
...
\addAttore{\admin}
\addPrC{L'\admin sta creando un nuovo allarme.}
\addPoC{L'orario di attivazione è configurato per l'allarme che si vuole creare.}
%\addTrigger{L'\admin deve configurare le soglie di attivazione dell'allarme.}
...
\addAttore{\admin}
\addPrC{L'\admin sta creando un nuovo allarme.}
\addPoC{L'orario di disattivazione è configurato per l'allarme che si vuole creare.}
%\addTrigger{L'\admin deve configurare le soglie di attivazione dell'allarme.}
...
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{L'allarme che si vuole modificare esiste nel sistema.}
\addPoC{La priorità dell'allarme viene aggiornata dal sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione allarmi;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla modifica di un allarme;}
%\addTrigger{L'\admin vuole modificare la priorità di un allarme.}
\addScenarioPrincipale{L'\admin seleziona la nuova priorità;}
\addScenarioPrincipale{L'\admin conferma l'operazione.}
\makeUC{\Mpa}{Modifica priorità allarme}

\addAttore{\admin}
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{L'allarme che si vuole modificare esiste nel sistema.}
\addPoC{La soglia d'intervento dell'allarme viene aggiornata dal sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione allarmi;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla modifica di un allarme;}
%\addTrigger{L'\admin vuole modificare la priorità di un allarme.}
\addScenarioPrincipale{L'\admin seleziona la nuova soglia d'intervento;}
\addScenarioPrincipale{L'\admin conferma l'operazione.}
\makeUC{\Msia}{Modifica soglia intervento allarme}

\addAttore{\admin}
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{L'allarme che si vuole modificare esiste nel sistema.}
\addPoC{L'orario di attivazione dell'allarme viene aggiornato dal sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione allarmi;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla modifica di un allarme;}
%\addTrigger{L'\admin vuole modificare la priorità di un allarme.}
\addScenarioPrincipale{L'\admin seleziona il nuovo orario di attivazione.}
\addScenarioPrincipale{L'\admin conferma l'operazione.}
\makeUC{\Moaa}{Modifica orario attivazione allarme}

\addAttore{\admin}
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{L'allarme che si vuole modificare esiste nel sistema.}
\addPoC{L'orario di disattivazione dell'allarme viene aggiornato dal sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione allarmi;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla modifica di un allarme;}
%\addTrigger{L'\admin vuole modificare la priorità di un allarme.}
\addScenarioPrincipale{L'\admin seleziona il nuovo orario di disattivazione.}
\makeUC{\Moda}{Modifica orario disattivazione allarme}

\addAttore{\admin}
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{L'allarme che si vuole abilitare esiste nel sistema.}
\addPoC{L'allarme viene abilitato dal Sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione allarmi;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla abilitazione di un allarme;}
\addScenarioPrincipale{L'\admin abilita un allarme dal Sistema.}
\makeUC{\Aal}{Abilita allarme}

\addAttore{\admin}
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{L'allarme che si vuole disabilitare esiste nel sistema.}
\addPoC{L'allarme viene disabilitato dal Sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione allarmi;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa alla disabilitazione di un allarme;}
\addScenarioPrincipale{L'\admin disabilita un allarme dal Sistema.}
\makeUC{\Dal}{Disabilita allarme}
...
\addPrC{Il Sistema è attivo;}
\addPrC{L'\admin è autenticato nel Sistema;}
\addPrC{L'allarme che si vuole eliminare esiste nel sistema.}
\addPoC{L'allarme viene eliminato dal Sistema.}
\addScenarioPrincipale{L'\admin seleziona dal menù l'opzione relativa alla gestione allarmi;}
\addScenarioPrincipale{L'\admin seleziona l'opzione relativa all'eliminazione di un allarme;}
\addScenarioPrincipale{L'\admin elimina un allarme dal Sistema.}
\makeUC[0.633]{\Ea}{Elimina allarme}
...
\addPrC{Il Sistema è attivo;}
\addPrC{L'\user è autenticato nel Sistema.}
\addPoC{L'\user visualizza l'elenco delle notifiche.}
...
\makeUC{\Vn}{Visualizzazione elenco notifiche}

\addAttore{\user}
\addPrC{L'\user sta visualizzando l'elenco delle notifiche.}
\addPoC{L'\user visualizza una singola notifica con le proprie informazioni.}
...
\addPoC{Il Sistema non autentica l'\user}
...
\section{Requisiti}
  In questa sezione viene presentata la specifica dei requisiti. In particolare i requisiti si dividono in:
  \begin{itemize}
      \item Funzionali: descrivono le funzionalità che un Sistema deve avere per soddisfare i bisogni;
      \item Di qualità: requisiti che devono essere rispettati per accertare qualità
            nella progettazione/sviluppo del Sistema.
      \item Di vincolo: restrizioni che devono essere rispettate durante la progettazione/sviluppo del Sistema.
  \end{itemize}
  ...
  \addReqF{2}{L'\user deve potersi autenticare presso il Sistema e impostare una nuova password}{\rif{\Aucp}} % 5
  ...
  \addReqF{2}{L'\user deve ricevere un errore se l'username non è registrato nel Sistema o
      la password temporanea non è corretta per l'\user inserito}{\rif{\Erpte}} % 8
  ...
  \addReqF{2}{L'\admin deve poter visualizzare se un account MyVimar è configurato nel Sistema}{\rif{\VaMV}} % 11
  \addReqF{2}{L'\admin visualizzando l'account MyVimar collegato deve visualizzare l'email dell'account}{\rif{\VaMV}\\\rif{\VaMV.1}}
  ...
  % --- CRUD utente ---
  \addReqF{1}{L'\admin deve poter visualizzare l'elenco degli utenti del Sistema}{\rif{\Vu}} % 15
  ...
  \addReqF{1}{L'\admin deve poter creare un utente \os}{\rif{\Cu}} % 20
  ...
  \addReqF{1}{L'\admin deve poter eliminare un utente \os}{\rif{\Eu}}

  % --- CRUD reparti ---
  \addReqF{2}{L'\admin deve poter visualizzare tutti i reparti del Sistema}{\rif{\Vr}} % 27
  ...
  \addReqF{2}{L'\admin deve poter assegnare un reparto a un appartamento}{\rif{\Aaapr}}
  \addReqF{2}{L'\admin deve selezionare un appartamento per assegnare a un appartamento un reparto}{\rif{\Aaapr}\\\rif{\Aaapr.1}}
  ...
  \addReqF{2}{L'\user visualizzando il modulo gestione allarmi deve poter visualizzare
      ogni singolo allarme}{\rif{\Vd.1}\\\rif{\Vd.1.1}}
  \addReqF{2}{L'\user visualizzando un singolo allarme deve poter visualizzare il segnale di pericolo}{\rif{\Vd.1.1}\\\rif{\Vd.1.1.1}}
  \addReqF{2}{L'\user visualizzando un singolo allarme deve poter visualizzare il nome}{\rif{\Vd.1.1}\\\rif{\Vd.1.1.2}}
  \addReqF{2}{L'\user visualizzando un singolo allarme deve poter visualizzare il tempo trascorso dallo scatto
  ...
  \addReqF{2}{L'\user visualizzando il modulo statistiche allarmi deve poter visualizzare il numero
      di allarmi risolti}{\rif{\Vd.2}\\\rif{\Vd.2.1}}
  \addReqF{2}{L'\user visualizzando il modulo statistiche allarmi deve poter visualizzare il numero
      di allarmi attivi}{\rif{\Vd.2}\\\rif{\Vd.2.2}}
  \addReqF{2}{L'\user visualizzando la dashboard deve poter visualizzare un modulo informazioni \user}{\rif{\Vd}\\\rif{\Vd.3}}
  \addReqF{2}{L'\user visualizzando il modulo informazioni \user deve poter visualizzare il
  ...
  \addReqF{1}{L'\admin deve poter aggiungere alla visualizzazione della dashboard un modulo tra i seguenti:
    \begin{itemize}
    ...
    \end{itemize}
  }{\rif{\Am}\\\rif{\Amsa}\\\rif{\Amiu}\\\rif{\Amacl}\\\rif{\Amaco}}
  \addReqF{1}{L'\admin deve poter rimuovere dalla visualizzazione della dashboard un modulo tra i seguenti:
    \begin{itemize}
        \item statistiche allarmi;
        \item informazioni Utente;
        \item analisi clima;
        \item analisi consumi.
    \end{itemize}
  }{\rif{\Rm}\\\rif{\Rmsa}\\\rif{\Rmiu}\\\rif{\Rmacl}\\\rif{\Rmaco}}
  \addReqF{2}{L'\user deve poter risolvere un allarme}{\rif{\Ra}}

  % --- Analytics UC20 --- 
  \addReqF{2}{L'\user deve poter visualizzare le analytics}{\rif{\Va}}
  \addReqF{2}{L'\user visualizzando le analytics deve visualizzare l'elenco dei suggerimenti risparmio energetico}{\rif{\Va}\\\rif{\Va.1}}
  \addReqF{2}{L'\user visualizzando l'elenco dei suggerimenti risparmio energetico deve visualizzare un suggerimento
      risparmio energetico}{\rif{\Va.1}\\\rif{\Va.1.1}}
  \addReqF{2}{L'\user visualizzando le analytics deve visualizzare il grafico dedicato al consumo energetico}{\rif{\Va}\\\rif{\Va.2}}
  \addReqF{2}{L'\user visualizzando le analytics deve visualizzare il grafico dedicato alle anomalie dell'impianto}{\rif{\Va}\\\rif{\Va.3}}
  \addReqF{2}{L'\user visualizzando le analytics deve visualizzare il grafico relativo al rilevamento di presenza}{\rif{\Va}\\\rif{\Va.4}}
  \addReqF{2}{L'\user visualizzando le analytics deve visualizzare il grafico relativo alla presenza prolungata nello stesso
      ambiente}{\rif{\Va}\\\rif{\Va.5}}
  \addReqF{2}{L'\user visualizzando le analytics deve visualizzare il grafico relativo alle variazioni di temperatura}{\rif{\Va}\\\rif{\Va.6}}
  \addReqF{2}{L'\user visualizzando le analytics deve visualizzare il grafico relativo agli allarmi inviati e risolti}{\rif{\Va}\\\rif{\Va.7}}
  \addReqF{0}{L'\user visualizzando le analytics deve visualizzare il grafico relativo alla frequenza degli allarmi}{\rif{\Va}\\\rif{\Va.8}}
  \addReqF{0}{L'\user visualizzando le analytics deve visualizzare il grafico relativo alla frequenza delle cadute}{\rif{\Va}\\\rif{\Va.9}}
  ...
  \addReqF{2}{L'\user visualizzando una stanza deve visualizzare il nome della stanza}{\rif{\Vap.3.1}\\\rif{\Vap.3.1.1}}
  \addReqF{2}{L'\user visualizzando una stanza deve visualizzare l'elenco dei dispositivi della stanza}{\rif{\Vap.3.1}\\\rif{\Vap.3.1.2}}
  \addReqF{2}{L'\user visualizzando l'elenco dei dispositivi deve visualizzare un singolo dispositivo di tipo:
      \begin{itemize}
          \item termostato;
  ...
  \addReqF{2}{L'\user visualizzando un dispositivo deve vedere il nome}{\rif{\Vap.3.1.2.1}\\\rif{\Vap.3.1.2.1.1}}
  \addReqF{2}{L'\user visualizzando un dispositivo deve vedere lo stato}{\rif{\Vap.3.1.2.1}\\\rif{\Vap.3.1.2.1.2}}
  \addReqF{0}{L'\user visualizzando un dispositivo deve vedere le azioni eseguibili}{\rif{\Vap.3.1.2.1}\\\rif{\Vap.3.1.2.1.3}}

  \addReqF{0}{L'\admin deve poter abilitare un appartamento nel Sistema}{\rif{\Aapp}}
  \addReqF{0}{L'\admin deve poter disabilitare un appartamento nel Sistema}{\rif{\Dapp}}
  ...
  \addReqF{2}{L'\admin deve selezionare una soglia di intervento per creare un allarme nel Sistema}{\rif{\Aa}\\\rif{\Aa.8}}
  ...
  \addReqQ{2}{Il codice sorgente dovra essere contenuto in un repository versionato tramite \textit{GIT$_G$}, esposto pubblicamente
     e con licenza open source (es. MIT, Apache 2)}{\capitolato \S 5.1}
  \addReqQ{2}{Le librerie o i framework che verranno utilizzati dovranno avere licenza open source}{\capitolato \S 5.1}
  \addReqQ{0}{Utilizzare servizi serverless come \textit{AWS$_G$} SimpleNotificationService (SNS) e \textit{AWS$_G$} Lambda per gli allarmi tramite
      Web Push Notification}{\capitolato\S 5.2.1}
  \addReqQ{0}{Utilizzare per la raccolta e la rielaborazione dati per le analytics è possibile valutare servizi serverless
      di \textit{AWS$_G$} Kinesis, \textit{AWS$_G$} Athena oppure \textit{AWS$_G$} CloudWatch, \textit{AWS$_G$} S3}{\capitolato\S 5.2.1}
  \addReqQ{2}{Consegnare una documentazione sull’architettura realizzata tramite il modello \textit{C4$_G$} (diagramma di contesto e di
  ...
  \addReqQ{2}{Consegnare spese stimate della propria soluzione in Cloud \textit{AWS$_G$} in base ai servizi previsti}{\capitolato\S6.1}
  ...
  \addReqQ{2}{L'applicazione web deve essere supportata dai seguenti browser con le seguenti versioni:
  \begin{itemize}
    \item Safari in versione 26.3;
    \item Chrome in versione 143.
  \end{itemize}
  }{Intervista}
  \makeReqQtable
  ...
  \addReqV{0}{Per l’infrastruttura Cloud è concesso utilizzare Terraform, \textit{AWS$_G$} CDK V2 o Ansible}{\capitolato \S 5.1}
  \addReqV{2}{L’applicativo deve prevedere l’uso della tecnologia \textit{KNX IoT 3rd party API$_G$}.}{\capitolato \S 5.1}
  ...
  \addReqV{0}{Distribuire con \textit{AWS$_G$} LightSail oppure \textit{AWS$_G$} EC2 con Docker installato l’infrastruttura Cloud}{\capitolato\S 5.2.1}
  \addReqV{1}{La soluzione viene implementata con un componente libreria backend realizzato ad hoc per l’interfacciamento con le
    API di \textit{KNX IoT$_G$}, potenzialmente indipendente e riutilizzabile separatamente come “SDK” (Software Development Kit).}{\capitolato\S 6.2}
  \addReqV{1}{Utilizzare per lo sviluppo della componente front-end uno dei seguenti framework:
  \begin{itemize}
    \item \textit{Angular$_G$} (in Typescript);
    \item React (in Typescript);
    \item Flask (in Python).
  \end{itemize}
  }{Intervista}
  \addReqV{1}{Utilizzare per lo sviluppo della componente back-end uno dei seguenti framework:
  \begin{itemize}
    \item \textit{Express$_G$} (in Typescript);
    \item Nestjs (in Typescript);
    \item Flask (in Python);
    \item Fast API (in Python).
  \end{itemize}
  }{Intervista}
  \addReqV{1}{Utilizzare come database relazionale uno dei seguenti:
  \begin{itemize}
    \item \textit{PostgreSQL$_G$};
    \item MySQL.
  \end{itemize}
  }{Intervista}
  \addReqV{1}{Utilizzare come database NoSQL uno dei seguenti:
  \begin{itemize}
    \item \textit{TimescaleDB$_G$};
    \item InfluxDB.
  \end{itemize}
  }{Intervista}
  \makeReqVtable

  \addUCT{\rif{\Au}}{\req{1}{2}\\\req{2}{2}\\\req{3}{2}}
  \addUCT{\rif{\Au.1}}{\req{2}{2}}
  \addUCT{\rif{\Au.2}}{\req{3}{2}}
  
  \addUCT{\rif{\Aucp}}{\req{5}{2}\\\req{6}{2}\\\req{7}{2}}
  \addUCT{\rif{\Aucp.1}}{\req{6}{2}}
  \addUCT{\rif{\Aucp.2}}{\req{7}{2}}

  \addUCT{\rif{\VaMV}}{\req{11}{2}\\\req{12}{2}}
  \addUCT{\rif{\VaMV.1}}{\req{12}{2}}
  \addUCT{\rif{\CaMV}}{\req{13}{2}}
  \addUCT{\rif{\RaMV}}{\req{14}{2}}

  \addUCT{\rif{\Vu}}{\req{15}{2}\\\req{16}{2}}
  \addUCT{\rif{\Vu}.1}{\req{16}{2}\\\req{17}{2}\\\req{18}{2}\\\req{19}{2}}
  \addUCT{\rif{\Vu}.1.1}{\req{17}{2}}
  \addUCT{\rif{\Vu}.1.2}{\req{18}{2}}
  \addUCT{\rif{\Vu}.1.3}{\req{19}{2}}

  \addUCT{\rif{\Cu}}{\req{20}{2}\\\req{21}{2}\\\req{22}{2}\\\req{23}{2}\\\req{24}{2}}
  \addUCT{\rif{\Cu.1}}{\req{21}{2}}
  \addUCT{\rif{\Cu.2}}{\req{22}{2}}
  \addUCT{\rif{\Cu.3}}{\req{23}{2}}
  \addUCT{\rif{\Cu.4}}{\req{24}{2}}
  \addUCT{\rif{\Eu}}{\req{26}{2}}
  ...
  \addUCT{\rif{\Cu}}{\req{20}{1}\\\req{21}{1}\\\req{22}{1}\\\req{23}{1}\\\req{24}{1}}
  \addUCT{\rif{\Cu.1}}{\req{21}{1}}
  \addUCT{\rif{\Cu.2}}{\req{22}{1}}
  \addUCT{\rif{\Cu.3}}{\req{23}{1}}
  \addUCT{\rif{\Cu.4}}{\req{24}{1}}

  % Eliminazione OS
  \addUCT{\rif{\Eu}}{\req{26}{1}}

  % Visualizza reparti
  \addUCT{\rif{\Vr}}{\req{27}{2}\\\req{28}{2}\\\req{29}{2}}
  \addUCT{\rif{\Vr.1}}{\req{28}{2}\\\req{29}{2}}
  \addUCT{\rif{\Vr.1.1}}{\req{29}{2}}

  % Creazione reparto
  \addUCT{\rif{\Cr}}{\req{30}{2}\\\req{31}{2}}
  \addUCT{\rif{\Cr.1}}{\req{31}{2}}

  \addUCT{\rif{\Mr}}{\req{33}{2}}
  \addUCT{\rif{\Er}}{\req{34}{2}}
  \addUCT{\rif{\Aaosr}}{\req{35}{2}\\\req{36}{2}\\\req{37}{2}}
  \addUCT{\rif{\Aaosr.1}}{\req{36}{2}}
  \addUCT{\rif{\Aaosr.2}}{\req{37}{2}}
  \addUCT{\rif{\Raosr}}{\req{38}{2}}
  \addUCT{\rif{\Aaapr}}{\req{39}{2}\\\req{40}{2}\\\req{41}{2}}
  \addUCT{\rif{\Aaapr.1}}{\req{40}{2}}
  \addUCT{\rif{\Aaapr.2}}{\req{41}{2}}

  \addUCT{\rif{\Raapr}}{\req{42}{2}}

  \addUCT{\rif{\Vd}}{\req{43}{2}\\\req{44}{2}\\\req{49}{2}\\\req{52}{2}\\\req{55}{2}\\\req{56}{2}\\\req{57}{2}}
  \addUCT{\rif{\Vd.1}}{\req{44}{2}\\\req{45}{2}}
  \addUCT{\rif{\Vd.1.1}}{\req{45}{2}\\\req{46}{2}\\\req{47}{2}\\\req{48}{2}}
  \addUCT{\rif{\Vd.1.1.1}}{\req{46}{2}}
  \addUCT{\rif{\Vd.1.1.2}}{\req{47}{2}}
  \addUCT{\rif{\Vd.1.1.3}}{\req{48}{2}}
  \addUCT{\rif{\Vd.2}}{\req{49}{2}\\\req{50}{2}\\\req{51}{2}}
  \addUCT{\rif{\Vd.2.1}}{\req{50}{2}}
  \addUCT{\rif{\Vd.2.2}}{\req{51}{2}}
  \addUCT{\rif{\Vd.3}}{\req{52}{2}\\\req{53}{2}\\\req{54}{2}}
  \addUCT{\rif{\Vd.3.1}}{\req{53}{2}}
  \addUCT{\rif{\Vd.3.2}}{\req{54}{2}}
  \addUCT{\rif{\Vd.4}}{\req{55}{2}}
  \addUCT{\rif{\Vd.5}}{\req{56}{2}}
  \addUCT{\rif{\Vd.6}}{\req{57}{2}}

  \addUCT{\rif{\Am}}{\req{58}{2}}
  \addUCT{\rif{\Amsa}}{\req{58}{2}}
  \addUCT{\rif{\Amiu}}{\req{58}{2}}
  \addUCT{\rif{\Amacl}}{\req{58}{2}}
  \addUCT{\rif{\Amaco}}{\req{58}{2}}

  \addUCT{\rif{\Rm}}{\req{59}{2}}
  \addUCT{\rif{\Rmsa}}{\req{59}{2}}
  \addUCT{\rif{\Rmiu}}{\req{59}{2}}
  \addUCT{\rif{\Rmacl}}{\req{59}{2}}
  \addUCT{\rif{\Rmaco}}{\req{59}{2}}

  \addUCT{\rif{\Ra}}{\req{60}{2}}
  \addUCT{\rif{\Va}}{
    \req{61}{2}\\\req{62}{2}\\\req{64}{2}\\\req{65}{2}\\\req{66}{2}\\\req{67}{2}\\\req{68}{2}\\\req{69}{2}
    \\\req{70}{0}\\\req{71}{0}}
  \addUCT{\rif{\Va.1}}{\req{62}{2}\\\req{63}{2}}
  \addUCT{\rif{\Va.1.1}}{\req{63}{2}}
  \addUCT{\rif{\Va.2}}{\req{64}{2}}
  \addUCT{\rif{\Va.3}}{\req{65}{2}}
  \addUCT{\rif{\Va.4}}{\req{66}{2}}
  \addUCT{\rif{\Va.5}}{\req{67}{2}}
  \addUCT{\rif{\Va.6}}{\req{68}{2}}
  \addUCT{\rif{\Va.7}}{\req{69}{2}}
  \addUCT{\rif{\Va.8}}{\req{70}{0}}
  \addUCT{\rif{\Va.9}}{\req{71}{0}}

  \addUCT{\rif{\Vap}}{\req{72}{2}\\\req{73}{2}\\\req{74}{0}\\\req{75}{2}}
  \addUCT{\rif{\Vap.1}}{\req{73}{2}}
  \addUCT{\rif{\Vap.2}}{\req{74}{0}}
  \addUCT{\rif{\Vap.3}}{\req{75}{2}\\\req{76}{2}}
  \addUCT{\rif{\Vap.3.1}}{\req{76}{2}\\\req{77}{2}\\\req{78}{2}}
  \addUCT{\rif{\Vap.3.1.1}}{\req{77}{2}}
  \addUCT{\rif{\Vap.3.1.2}}{\req{78}{2}\\\req{79}{2}}
  \addUCT{\rif{\Vap.3.1.2.1}}{\req{79}{2}\\\req{80}{2}\\\req{81}{2}\\\req{82}{0}}
  \addUCT{\rif{\Vap.3.1.2.1.1}}{\req{80}{2}}
  \addUCT{\rif{\Vap.3.1.2.1.2}}{\req{81}{2}}
  \addUCT{\rif{\Vap.3.1.2.1.3}}{\req{82}{0}}
  \addUCT{\rif{\Vap.3.1.2.2}}{\req{79}{2}}
  \addUCT{\rif{\Vap.3.1.2.3}}{\req{79}{2}}
  \addUCT{\rif{\Vap.3.1.2.4}}{\req{79}{2}}
  \addUCT{\rif{\Vap.3.1.2.5}}{\req{79}{2}}
  \addUCT{\rif{\Vap.3.1.2.6}}{\req{79}{2}}
  \addUCT{\rif{\Vap.3.1.2.7}}{\req{79}{2}}
  \addUCT{\rif{\Vap.3.1.2.8}}{\req{79}{2}}
  \addUCT{\rif{\Aapp}}{\req{83}{0}}
  \addUCT{\rif{\Dapp}}{\req{84}{0}}
  \addUCT{\rif{\Aa}}{\req{85}{2}\\\req{86}{2}\\\req{87}{2}\\\req{88}{2}\\\req{89}{2}\\\req{90}{2}\\\req{91}{2}}
  \addUCT{\rif{\Aa.1}}{\req{86}{2}}
  \addUCT{\rif{\Aa.2}}{\req{87}{2}}
  \addUCT{\rif{\Aa.3}}{\req{88}{2}}
  \addUCT{\rif{\Aa.4}}{\req{88}{2}}
  \addUCT{\rif{\Aa.5}}{\req{88}{2}}
  \addUCT{\rif{\Aa.6}}{\req{88}{2}}
  \addUCT{\rif{\Aa.7}}{\req{88}{2}}
  \addUCT{\rif{\Aa.8}}{\req{89}{2}}
  \addUCT{\rif{\Aa.9}}{\req{90}{2}}
  \addUCT{\rif{\Aa.10}}{\req{91}{2}}
  \addUCT{\rif{\Mpa}}{\req{95}{2}}
  \addUCT{\rif{\Msia}}{\req{96}{2}}
  \addUCT{\rif{\Moaa}}{\req{97}{2}}
  \addUCT{\rif{\Moda}}{\req{98}{2}}
  \addUCT{\rif{\Aal}}{\req{99}{2}}
  \addUCT{\rif{\Dal}}{\req{100}{2}}
  \addUCT{\rif{\Ea}}{\req{101}{2}}
  \addUCT{\rif{\Vn}}{\req{102}{0}\\\req{103}{0}}
  \addUCT{\rif{\Vn.1}}{\req{103}{0}\\\req{104}{0}\\\req{105}{0}}
  \addUCT{\rif{\Vn.1.1}}{\req{104}{0}}
  \addUCT{\rif{\Vn.1.2}}{\req{105}{0}}
  \addUCT{\rif{\Erunr}}{\req{4}{2}}
  \addUCT{\rif{\Erpte}}{\req{8}{2}}
  \addUCT{\rif{\Ernpupt}}{\req{9}{2}}
  \addUCT{\rif{\Ernpnv}}{\req{10}{2}}
  \addUCT{\rif{\Eruu}}{\req{25}{2}}
  \addUCT{\rif{\Ernru}}{\req{32}{2}}
  \addUCT{\rif{\Ernru}}{\req{32}{2}}
  \addUCT{\rif{\Erns}}{\req{92}{2}}
  \addUCT{\rif{\Ernlp}}{\req{93}{2}}
  \addUCT{\rif{\Ernss}}{\req{94}{2}}
