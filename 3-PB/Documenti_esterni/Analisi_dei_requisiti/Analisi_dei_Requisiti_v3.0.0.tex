...
\addAttore{\user}
\addPrC{L'\user sta visualizzando la dashboard.}
\addPoC{L'\user visualizza il grafico che riporta l'andamento della temperatura espressa in gradi Celsius nelle ultime 12 ore.}
...
\addAttore{\user}
\addPrC{L'\user sta visualizzando la dashboard.}
\addPoC{L'\user visualizza il grafico che riporta l'andamento dei consumi espressi in watt nelle ultime 12 ore.}
