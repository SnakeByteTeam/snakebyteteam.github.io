...
\addMet{+}{getAllManagedAlarmEventsByUserId(req: GetAllManagedAlarmEventsByUserIdCmd): Promise$<$AlarmEvent[]$>$}{Recupera gli eventi gestiti da un utente delegando alla porta di persistenza}
