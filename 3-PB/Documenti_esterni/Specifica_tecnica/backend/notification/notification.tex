...
\addMet{+}{\texttt{writeNotification(ward\_id: number, alarm\_id: string, timestamp: string): Promise<boolean>}}{Persiste una notifica nel database con wardId, alarmId e timestamp}
