...
\addAtr{+}{alarmId: string}{}
\addAtr{+}{wardId: number}{}
\makeCl{NotifyAlarmResolutionCmd}{Comando che trasporta alarmId e wardId per notificare la risoluzione di un allarme}

% application\commands\notify-alarm-ward.command.ts
\addAtr{+}{alarm: CheckAlarm}{}
\makeCl{NotifyAlarmWardCmd}{Comando che trasporta wardId e i dati dell'allarme per notificare un reparto}

% application\commands\write-notification.command.ts
\addAtr{+}{timestamp: string}{}
\addAtr{+}{alarm\_event\_id: string}{}
\addAtr{+}{ward\_id: number}{}
\makeCl{WriteNotificationCmd}{Comando che trasporta i dati per persistere una notifica}
