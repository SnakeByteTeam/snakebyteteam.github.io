...
\addTec{\glossario{TimescaleDB}}{2.26.3}{Estensione di PostgreSQL per la gestione di dati \textit{timeseries}.}
...
\addTec{\textit{Vitest}}{4.1.2}{\textit{Framework} di testing unitario basato su Vite, caratterizzato da un'esecuzione estremamente rapida, supporto nativo a ESM e piena compatibilità con l'API di Jest.}
