...
\captionof{figure}{\href{https://snakebyteteam.github.io/3-PB/Documenti_esterni/Specifica_tecnica/frontend/notifications/notification.pdf}{Diagramma delle classi del modulo Notifications}}
\end{center}
...
\makeCl{NotificationEvent}{Interfaccia che rappresenta una singola notifica di sistema, condivisa tra lo storico HTTP e gli eventi push real-time. La simmetria tra le due sorgenti consente a NotificationService di unirle senza trasformazioni intermedie.}

\addAtr{+}{notifications: NotificationEvent[]}{}
\addAtr{+}{unreadCount: number}{}
\makeCl{NotificationListVm}{Interfaccia che rappresenta il view model della pagina delle notifiche, prodotto da NotificationService tramite combineLatest. Aggrega la lista unificata e deduplicata delle notifiche e il contatore delle non lette in un unico snapshot atomicamente coerente.}
