...
\captionof{figure}{\href{https://snakebyteteam.github.io/3-PB/Documenti_esterni/Specifica_tecnica/frontend/my-vimar-integration/my-vimar-integration.pdf}{Diagramma delle classi del modulo MyVimar integration}}
\end{center}
...
\makeCl{MyVimarAccount}{Interfaccia che rappresenta le informazioni dell'account MyVimar collegato. Espone l'indirizzo email e lo stato di collegamento dell'account.}
