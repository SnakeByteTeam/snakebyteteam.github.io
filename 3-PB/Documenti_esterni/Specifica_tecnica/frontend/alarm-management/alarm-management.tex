...
\captionof{figure}{Diagramma delle classi del modulo Alarm-management}
\end{center}
...
\makeAbCl{ActiveAlarmTableRow}{Tipo che rappresenta una riga della tabella degli allarmi attivi. Raccoglie le informazioni di priorità, posizione, stato e i flag necessari alla gestione dell'azione di risoluzione.}
...
\makeAbCl{AlarmListVm}{Interfaccia che rappresenta il view model della lista degli allarmi attivi, contenente i dati della pagina corrente, lo stato di paginazione e le informazioni sull'eventuale risoluzione in corso.}
