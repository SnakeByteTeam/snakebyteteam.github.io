...
\captionof{figure}{\href{https://snakebyteteam.github.io/3-PB/Documenti_esterni/Specifica_tecnica/frontend/alarm-configuration/alarm-configuration.pdf}{Diagramma delle classi del modulo Alarm-configuration}}
\end{center}
...
\makeCl{AlarmConfigFormValue}{Interfaccia che rappresenta il valore del form di configurazione di una regola di allarme. Raccoglie tutti i campi necessari per la creazione e la modifica di una regola, inclusi dispositivo, datapoint, soglia e orari di armamento.}
...
\makeCl{AlarmConfigTableRow}{Tipo che rappresenta una riga della tabella di configurazione delle regole di allarme. Raccoglie le informazioni di posizione, priorità, soglia e orari di armamento da visualizzare nella tabella.}
