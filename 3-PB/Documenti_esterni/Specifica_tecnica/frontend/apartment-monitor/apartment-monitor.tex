...
\captionof{figure}{\href{https://snakebyteteam.github.io/3-PB/Documenti_esterni/Specifica_tecnica/frontend/apartment-monitor/apartment-monitor.pdf}{Diagramma delle classi del modulo Apartment monitor}}
\end{center}
...
\addAtr{+}{rooms: Room[]}{}
\makeCl{Apartment}{Interfaccia che rappresenta il modello di dominio di un appartamento. Aggrega le informazioni identificative, lo stato di abilitazione e la lista delle stanze.}
...
\makeCl{Datapoint}{Interfaccia che rappresenta un datapoint di un dispositivo. Definisce le proprietà di lettura, scrittura, tipo di valore e valori enumerati disponibili.}

\addAtr{+}{key: string}{}
\addAtr{+}{label: string}{}
\addAtr{+}{disabled?: boolean}{}
\makeCl{DeviceAction}{Interfaccia che rappresenta un'azione eseguibile su un dispositivo. Associa una chiave identificativa a un'etichetta visualizzabile e a un flag opzionale di disabilitazione.}
...
\makeCl{Device}{Interfaccia che rappresenta il modello di dominio di un dispositivo. Raccoglie tipo, stato, azioni disponibili e datapoint associati.}
...
\addAtr{+}{enum?: string[]}{}
\addAtr{+}{sfeType: string}{}
\makeCl{PlantDatapointDto}{Interfaccia che rappresenta il DTO di un datapoint restituito dal backend nella risposta dell'impianto.}
...
\makeCl{PlantDeviceDto}{Interfaccia che rappresenta il DTO di un dispositivo restituito dal backend nella risposta dell'impianto.}

\addAtr{+}{id: string}{}
\addAtr{+}{name: string}{}
\addAtr{+}{devices: PlantDeviceDto[]}{}
\makeCl{PlantRoomDto}{Interfaccia che rappresenta il DTO di una stanza restituita dal backend nella risposta dell'impianto.}

\addAtr{+}{id: string}{}
\addAtr{+}{name: string}{}
\addAtr{+}{wardId?: number}{}
\addAtr{+}{rooms: PlantRoomDto[]}{}
\makeCl{PlantDto}{Interfaccia che rappresenta il DTO di un impianto restituito dal backend, contenente le stanze e l'eventuale identificativo del ward associato.}

\addAtr{+}{id: string}{}
\addAtr{+}{name: string}{}
\addAtr{+}{hasActiveAlarm: boolean}{}
\addAtr{+}{devices: Device[]}{}
\makeCl{Room}{Interfaccia che rappresenta il modello di dominio di una stanza. Aggrega le informazioni identificative, lo stato di allarme attivo e la lista dei dispositivi presenti.}
