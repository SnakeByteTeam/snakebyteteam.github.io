...
unicamente in seguito al superamento dei test nel \textit{develop$_G$}.
...
\addDecision{Richiedere colloquio al prof. Cardin}
\makeDecisionTable

% -------------------------------------------------
% Azioni
% -------------------------------------------------
\addTodo{\#5}{Implementare gestione utenti lato \textit{backend}}{L. Pellizzon}{22/03/2026}
\addTodo{\#6}{Implementare autenticazione alle \textit{API Vimar} e sviluppare modulo allarmi}{L. Granziero, F. Venzo}{22/03/2026}
\addTodo{\#7}{Implementare modulo \textit{analytics} lato \textit{backend}}{V. Baleanu, G. De Fina}{22/03/2026}
\addTodo{\#8}{Implementare \textit{feature} di ricezione notifiche lato \textit{frontend}}{G. De Fina}{22/03/2026}
