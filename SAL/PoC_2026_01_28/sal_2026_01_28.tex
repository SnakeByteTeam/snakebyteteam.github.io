...
\begin{frame}{Scelta del Database}
 \begin{itemize}
  \item I dati dell’applicativo web, come utenti, credenziali e configurazioni... saranno gestiti con un database relazionale (PostgreSQL o MySQL) per garantire integrità e coerenza.
