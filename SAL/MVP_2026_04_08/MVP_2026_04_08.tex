...
\begin{frame}{Autenticazione(1/3): funzionalità }
  ...
  Il flusso di questa operazione è di seguito riportato:
  
\end{frame}

\begin{frame}{Autenticazione(2/3): flusso}
  \centering
  \includegraphics[                                
    width=\textwidth,
    height=\textheight,
    keepaspectratio
  ]{autenticazione-flusso.png}
\end{frame}

\begin{frame}{Autenticazione(3/3): interfaccia}
  \centering
  \includegraphics[                                
    width=\textwidth,
    height=\textheight,
...
\begin{frame}{Gestione Allarmi(1/3): funzionalità }
...
\begin{frame}{Gestione Allarmi(2/3): flusso }
  \centering
  \includegraphics[                                
    width=\textwidth,
    height=\textheight,
...
\begin{frame}{Gestione Allarmi(3/3): interfaccia }
  \centering
  \includegraphics[                                
    width=\textwidth,
    height=\textheight,
...
\begin{frame}{Configurazione Allarmi (1/3): funzionalità}
  ...
  Prevede la possibilità di:
  \begin{itemize}                                
    \item Visualizzare la lista degli allarmi;
    \item Eliminare, disabilitare allarmi o modificarne le caratteristiche (ad esempio priorità, soglia, orario d'attivazione, ...).
    \item Creare nuovi allarmi tramite modulo dedicato.
  \end{itemize}
\end{frame}
...
\begin{frame}{Analytics(1/3): funzionalità }
  ...
  Sulla base di questi, e in riferimento alle metriche compatibili (ad esempio la temperatura giornaliera), 
  viene dinamicamente interrogato un LLM
  che produce una serie di suggerimenti per il risparmio energetico.
  \begin{itemize}                                
...
\begin{frame}{Analytics(2/3): flusso }
  \centering
  \includegraphics[                                
    width=\textwidth,
    height=\textheight,
...
\begin{frame}{Analytics(3/3): interfaccia }
  \centering
  \includegraphics[                                
    width=\textwidth,
    height=\textheight,
...
\begin{frame}{Altre funzionalità amministratore}
  ...
  \begin{itemize}                                
    \item Gestione Reparti: permette di amministrare le relazioni di appartenenza tra appartamento e reparto, e tra operatore sanitario e reparto.
...
\begin{frame}{Modello architetturale (2/2)}
  \centering
  \includegraphics[                                
    width=\textwidth,
    height=0.8\textheight,
