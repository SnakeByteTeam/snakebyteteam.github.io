...
\begin{frame}{Funzionalità principali - Dashboard}
  \centering
  \includegraphics[
    width=\textwidth,
    height=\textheight,
...
\begin{frame}{Funzionalità principali - Gestione Allarmi}
  \centering
  \includegraphics[
    width=\textwidth,
    height=\textheight,
...
\begin{frame}{Funzionalità principali - Configurazione Allarmi}
  \centering
  \includegraphics[
    width=\textwidth,
    height=\textheight,
...
\begin{frame}{Funzionalità principali - Analytics}
  \centering
  \includegraphics[
    width=\textwidth,
    height=\textheight,
...
\begin{frame}{Modello C4 (context overview)}
 \centering
  \includegraphics[
    width=\textwidth,
...
\begin{frame}{Modello C4 (container)}
 \centering
  \includegraphics[
    width=\textwidth,
    height=0.8\textheight,
...
\begin{itemize}
    ...
    \item Gestione del progetto mediante metodologia Scrum, 
          con organizzazione del lavoro in sprint
    \item Esposizione a un flusso di lavoro professionale, 
          tra cui versionamento, documentazione e coordinamento del team
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item Disallineamento sui requisiti di progetto 
\end{itemize}
\end{frame}
