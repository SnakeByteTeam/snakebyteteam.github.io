...
Sulla base di questi, e in riferimento alle metriche compatibili (ad esempio la temperatura giornaliera), viene dinamicamente interrogato un LLM (Groq modello boh?)
