...
Durante l'ultimo periodo di avanzamento sono emersi alcuni dubbi:
  \begin{itemize}
      ...
      integrazioni?
      \item È concesso l'utilizzo di un ORM (Object-Relational Mapping) come Prisma che, partendo dal modello dei dati, può generare le migrazioni per creare automaticamente le tabelle nel database?
