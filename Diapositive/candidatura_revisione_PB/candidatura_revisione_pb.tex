...
\begin{itemize}
    ...
    \begin{itemize}
      \item Implementato tramite \textit{RxJS}: le entità si iscrivono 
...
\begin{frame}{Pattern - Observer (3/3)}
\begin{figure}
  \centering
    \includegraphics[width=0.8\textwidth]{img/analyticsSnippet.png}
    \caption{analytics.component.ts}
    \includegraphics[width=0.5\textwidth]{img/analyticsSnippetTemplate.png}
