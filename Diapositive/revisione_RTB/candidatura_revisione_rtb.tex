...
\begin{frame}{Comprensione degli obiettivi del capitolato}
  A partire dal capitolato, l'attività di Analisi dei Requisiti ha generato i requisiti del prodotto così classificati:
  \vspace{0.8em}
  \begin{center}
    \footnotesize
...
\begin{frame}{Autovalutazione}
  \begin{itemize}
    ...
    \item Le criticità maggiori derivano dalla poca esperienza dei membri nel fare delle stime orarie corrette;
          \vspace{0.6em}
    \item Numerose ripianificazioni dei ruoli ricoperti durante gli \textit{sprint}$_G$;
          \vspace{0.6em}
...
\begin{frame}{Esito del colloquio TB}
  Criticità segnalate dal prof. Cardin:
  \vspace{1.5em}
  \begin{itemize}
    \item Ambiguità relative ad alcuni \textit{use case$_G$} nell'Analisi dei Requisiti;
          \vspace{1em}
    \item Scelta del \textit{framework Express$_G$} come tecnologia per lo sviluppo della componente \textit{backend}.
  \end{itemize}
\end{frame}

\begin{frame}[shrink=20]{Consuntivo di periodo attuale (sprint 8)}
  \vspace{1.75cm}
  \begin{center}
    \small
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
      ...
      \hline
      \cellcolor{aziendaPrimary!20} V. Baleanu   & 8h                                            & 16h                                           & 13h                 & 4h                 & 0h                 & 17h                 & \textbf{58h}        \\
      \hline
      \cellcolor{aziendaPrimary!20} G. De Fina   & 8h                                            & 26h                                           & 15h                 & 0h                 & 4h                 & 10h                 & \textbf{63h}        \\
      \hline
      \cellcolor{aziendaPrimary!20} L. Granziero & 9h                                            & 0h                                            & 14h                 & 8h                 & 11h                & 16h                 & \textbf{58h}        \\
      \hline
      \cellcolor{aziendaPrimary!20} C. Libralato & 9h                                            & 18h                                           & 6h                  & 2h                 & 11h                & 0h                  & \textbf{46h}        \\
      \hline
      \cellcolor{aziendaPrimary!20} F. Pasqual   & 8h                                            & 14h                                           & 5h                  & 0h                 & 10h                & 32h                 & \textbf{69h}        \\
      \hline
      \cellcolor{aziendaPrimary!20} L. Pellizzon & 8h                                            & 0h                                            & 20h                 & 18h                & 8h                 & 15h                 & \textbf{69h}        \\
      \hline
      \cellcolor{aziendaPrimary!20} F. Venzo     & 13h                                           & 7h                                            & 16h                 & 0h                 & 15h                & 6h                  & \textbf{57h}        \\
      \hline
      \cellcolor{aziendaPrimary!20}
      \textbf{Totale}                            & \textbf{63h}                                  & \textbf{81h}                                  & \textbf{89h}        & \textbf{32h}       & \textbf{59h}       & \textbf{96h}        & \textbf{420h}       \\
      \hline
      \cellcolor{aziendaPrimary!20}
      \textbf{Risorse}                           & \textbf{1890 \euro}                           & \textbf{1620 \euro}                           & \textbf{2225 \euro} & \textbf{800 \euro} & \textbf{885 \euro} & \textbf{1440 \euro} & \textbf{8860 \euro} \\
      \hline
    \end{tabular}
  \end{center}
...
\begin{frame}[shrink=10]{Preventivo a finire}
  ...
  \begin{center}
    ...
    \begin{tabular}{|c|c|c|}
      ...
      \hline
      Responsabile                                  & 15h                    & 450 \euro                 \\
      \hline
      Amministratore                                & 20h                    & 400 \euro                 \\
      \hline
      Analista                                      & 0h                     & 0 \euro                   \\
      \hline
      Progettista                                   & 56h                    & 1400 \euro                \\
      \hline
      Programmatore                                 & 83h                    & 1245 \euro                \\
      \hline
      Verificatore                                  & 46h                    & 690 \euro                 \\
      \hline
      \cellcolor{aziendaPrimary!20} \textbf{Totale} & \textbf{220h}          & \textbf{4185 \euro}       \\
      \hline
    \end{tabular}
