  ...
  \begin{center}
        \begin{tabular}{|c|c|c|c|c|c|c|c|}
            \hline
              & \textbf{Resp.} & \textbf{Amm.} & \textbf{Ana.} & \textbf{Proge.} & \textbf{Progr.} & \textbf{Ver.} & \textbf{Totale} \\
            \hline
            V. Baleanu & X & X & X & X & X & X & X\\
            \hline
            G. De Fina & X & X & X & X & X & X & X \\
            \hline
            L. Granziero & X & X & X & X & X & X & X \\
            \hline 
            C. Libralato & X & X & X & X & X & X & X\\
            \hline
            F. Pasqual  & X & X & X & X & X & X & X\\
            \hline
            L. Pellizzon & X & X & X & X & X & X & X\\
            \hline
            F. Venzo & X & X & X & X & X & X & X \\
            \hline
            \textbf{Totale}  & X & X & X & X & X & X & X \\
            \hline
        \end{tabular}
    \end{center}
\end{frame}
